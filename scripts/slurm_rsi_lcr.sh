#!/usr/bin/env bash
# =============================================================================
# slurm_rsi_lcr.sh — Slurm job: RSI-LCR ontology induction (Zone 3 only)
#
# Runs RSI-LCR on an EXISTING Zone 2 graph (no re-extraction).
# Zone 2 must have already populated Neo4j with :Entity nodes.
#
# Submit:  sbatch scripts/slurm_rsi_lcr.sh
# Monitor: squeue -u $USER
# Logs:    tail -f /local/scratch/$USER/logs/<jobid>.out
#
# Override: sbatch --export=ALL,MODEL=llama3.3:70b,SUFFIX=zone3_rsi_llama scripts/slurm_rsi_lcr.sh
# =============================================================================

#SBATCH --job-name=cs584_rsi_lcr
#SBATCH --gres=gpu:2
#SBATCH --mem=96G
#SBATCH --time=4:00:00
...
SUFFIX=${SUFFIX:-zone3_rsi}
K=${K:-}                          # empty = silhouette-guided
...
echo "============================================================"
echo "CS584 — RSI-LCR Ontology Induction (Zone 3 Only)"
echo "  Job ID:     $SLURM_JOB_ID"
echo "  Host:       $(hostname)"
echo "  Model:      $MODEL"
echo "  Suffix:     $SUFFIX"
echo "  K:          ${K:-auto (silhouette)}"
echo "  Rounds:     $REFINEMENT_ROUNDS"
...
# ---------------------------------------------------------------------------
echo "================================================================"
echo "ZONE 3 — RSI-LCR with $MODEL"
echo "  Started: $(date)"
echo "================================================================"
...
echo ""
echo "RSI-LCR complete: ${ZONE3_TIME}s ($(date))"
echo ""
...
echo ""
echo "Timing:"
echo "  Zone 3 (RSI-LCR): ${ZONE3_TIME}s"
echo "  Evaluation:        ${EVAL_TIME}s"
echo "  Total:             $((ZONE3_TIME + EVAL_TIME))s"
echo ""
echo "Results:"
echo "  zone3_rsi_lcr_summary_${SUFFIX}.json"
